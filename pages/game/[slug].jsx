    ...
    <Container customMeta={customMeta}>
      <div className="w-full min-h-[60rem] h-full flex flex-col justify-start items-center">
        <div className="flex w-full justify-center">
          ...
          >
            {post.img !== "" && (
              <div className="relative left-0 top-0 w-full h-fit overflow-hidden flex justify-center items-center rounded-xl md:mt-3">
                <Image
                  src={post.img}
                  width={1000}
                  height={500}
                  alt={"대표 이미지"}
                  className="object-contain rounded-xl transition-all duration-300 hover:scale-105"
                ></Image>
              </div>
            )}
